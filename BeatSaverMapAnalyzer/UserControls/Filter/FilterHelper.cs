...
namespace RandomSongTournamentAssistant.UserControls.Filter
{
    public static class FilterHelper
    {
        ...
        public static async Task SetFilterPageNumbers(HttpClient client, int minValue, string dataTypeName)
        {
            #region Get FilterData

            FilterData filterData = null;

            string filterDataFileName = "filterData.json";
        ...
        public static async Task SetRandomKey(HttpClient client, Random rnd)
        {
